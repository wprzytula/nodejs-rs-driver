...
pub struct KeyspaceWrapper {
    ...
    user_defined_types: NapiRefCache<js_constructible_class::Udt>,
}
...
impl KeyspaceWrapper {
    pub(crate) fn new(inner: Keyspace) -> Self {
        KeyspaceWrapper {
            ...
            user_defined_types: NapiRefCache::new(),
        }
    }
}
...
impl SessionWrapper {
    ...
    /// same UDT, whether through this method or through `KeyspaceWrapper::userDefinedTypes`,
    ...
    pub fn get_udt<'env>(
        ...
        with_custom_error_sync(|| {
            self.with_cluster_snapshot(env, |snapshot| {
                ...
                ks.user_defined_types.get_or_init(env, &name, || {
...
impl KeyspaceWrapper {
    ...
    pub fn user_defined_types<'env>(
        &self,
        env: &'env Env,
    ) -> JsResult<NamedMap<String, JsInstance<'env, js_constructible_class::Udt>>> {
        with_custom_error_sync(|| {
            let udts = self.user_defined_types.get_or_init_all(env, || {
                self.inner
                    .user_defined_types
                    .iter()
